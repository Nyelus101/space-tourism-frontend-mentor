  ...
  return (
    <>
      <div className='flex items-center justify-between p-5 w-357 h-88'>
        ...
        <nav className={`${nav ? 'block' : 'hidden'} md:flex md:items-center md:space-x-8 md:relative md:top-0 md:right-0 md:w-auto md:bg-transparent absolute top-0 right-0 w-[254px] h-full bg-white z-[2000]`}>
        <ul className='pl-[32px] space-y-8 relative top-[133px] md:top-0 md:pl-0 md:space-y-0 md:flex md:space-x-8'>
          <li>00 HOME</li>
          <li>01 DESTINATION</li>
          <li>02 CREW</li>
          <li>03 TECHNOLOGY</li>
